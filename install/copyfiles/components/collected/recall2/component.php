...
$arParams["EVENT_TYPE"] = "COLLECTED_RECALL2";
$arParams["REQUEST_PARAM_NAME"] = "collected_recall2";
...
if(!function_exists('collected_add_recall2_type'))
{
	function collected_add_recall2_type($EVENT_TYPE)
	{
...
if($_REQUEST[$arParams["REQUEST_PARAM_NAME"]]=="Y" && class_exists(CEventType) && class_exists(CEventMessage))
{
	...
	if(!$arET = $rsET->Fetch())
	{
		collected_add_recall2_type($arParams["EVENT_TYPE"]);
	}
	$arResult["LAST_ERROR"] = "";
	$arResult["GOOD_SEND"] = "";
