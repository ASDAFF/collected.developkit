...
$MESS["RS_DEVELOPKIT.RNA.ARCHIVE_URL"] = "Страница архива";
$MESS["RS_DEVELOPKIT.RNA.SHOW_TITLE"] = "Показывать заголовок";
$MESS["RS_DEVELOPKIT.RNA.SHOW_YEARS"] = "Показывать года";
$MESS["RS_DEVELOPKIT.RNA.SHOW_MONTHS"] = "Показывать месяца";
?>