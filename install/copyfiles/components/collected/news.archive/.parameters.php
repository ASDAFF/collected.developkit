...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
	    ...
	    */
	    ...
	    "SHOW_TITLE" => array(
	        "PARENT" => "ADDITIONAL_SETTINGS",
	        "NAME" => GetMessage("RS_DEVELOPKIT.RNA.SHOW_TITLE"),
	        "TYPE" => "CHECKBOX",
	        "DEFAULT" => "Y",
	    ),
	    "SHOW_YEARS" => array(
	        "PARENT" => "ADDITIONAL_SETTINGS",
	        "NAME" => GetMessage("RS_DEVELOPKIT.RNA.SHOW_YEARS"),
	        "TYPE" => "CHECKBOX",
	        "DEFAULT" => "Y",
	    ),
	    ...
	    "SHOW_MONTHS" => array(
	        "PARENT" => "ADDITIONAL_SETTINGS",
	        "NAME" => GetMessage("RS_DEVELOPKIT.RNA.SHOW_MONTHS"),
	        "TYPE" => "CHECKBOX",
	        "DEFAULT" => "Y",
	    ),
	),
...
if ($arCurrentValues['USE_ARCHIVE'] == 'Y') {
    ...
    $arTemplateParameters["ARCHIVE_URL"] = CIBlockParameters::GetPathTemplateParam(
        "SECTION",
        "ARCHIVE_URL",
        GetMessage("RS_DEVELOPKIT.NEWS_ARCHIVE.ARCHIVE_URL"),
